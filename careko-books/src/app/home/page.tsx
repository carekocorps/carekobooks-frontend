...
export default function HomeContent() {
  ...
  const { progresses } = useStatusProgresses({
  ...
  return (
      <section className="flex flex-col w-full mt-8 gap-12 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1fr_300px] gap-8 w-full overflow-x-hidden">
          {/* Conteúdo principal */}
          ...
          <div className="flex flex-col gap-6 w-full max-w-full xl:w-[300px]">
